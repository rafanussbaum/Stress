...
\end{itemize}
&
\raisebox{-1.1\totalheight}{\includegraphics[width=5cm]{SS_DownwardDog}}
\end{tabular}
...
\begin{tabular}{p{5cm} p{6.5cm}}
 \raisebox{-1.1\totalheight}{\includegraphics[width=5.3cm]{SS_Prostrate}} &
\begin{itemize}
...
\end{itemize}
&
\raisebox{-1.1\totalheight}{\includegraphics[width=5cm]{SS_Cobra}}
\end{tabular}
