...
\index{exercise!laughing}\label{Ex:Laughing}
...
Caused bu this reaction, the brain excretes ``joy hormones'', the so called \emph{endorphins}.\index{endorphins}\index{effect!endorphins, release}
...
Thereby he made a fantastic discovery: after ten minutes of intense laughing, his pains subsided\index{symptom!pain} and he was able to sleep for two hours without problems.
...
Laughing has a pain--relieving effect and strengthens the immune system.\index{immune system}\index{laughing!effects}\index{effect!immune system, strenghten}
For instance are the values of the natural killer cells and antibodies higher in people\index{effect!killer cells, increase}\index{effect!antibody count, increase},
who just have seen a funny movie.
Japanese researcher were able to treat this way successfully allergies\index{symptom!allergy}, by amusing the patients with movies.
...
This has also a positive effect on the heart--circulation system.\index{effect!heart}\index{effect!circulation, improve}
We breathe more intensely and deeply from our belly.\index{effect!breathing, intensify}\index{effect!breathing, deepen}
The lung gets well oxygenated, which leads to higher oxygen levels in the blood.\index{effect!lungs, oxygenated}\index{effect!blood, oxygenated}
This in turn activates the combustion processes in the body.\index{effect!burning processes, activated}
First, the heart rate increases, and soon after decreases again, which leads to a decrease of our blood pressure.\index{symptom!blood pressure, high}\index{effect!blood pressure, decrease}
The muscles, which were tensed up as we started laughing, relax in a sustainable manner.\index{effect!muscles, relax}

Laughing also lowers the production of the stress hormones adrenaline and cortisol.\index{effect!stress hormones, lower}
Instead, the body excretes endorphin.\index{effect!endorphines}
...
According to gelotologists, laughing also inspires creativity.\index{effect!creativity, inspire}
...
Laughing keeps us fit\index{effect!fitness}, helps against spring exhaustion\index{symptom!exhaustion}
and furthermore increases the sexual performance.\index{effect!sexual performance}
