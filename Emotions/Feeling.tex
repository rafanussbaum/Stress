...
Caused bu this reaction, the brain excretes ``joy hormones'', the so called \emph{endorphines}.\index{endorphines}
...
Gelotology\index{gelotology} is concerned with the physical and psychological effects on humnas of laughing and smiling.
...
Research of laughter became popular at the end of the 70ies, when the science journalist Norman Cousin\index{Norman Cousin} laid the decissive foundation with the report of his experiences.
...
\mytextbox[0]{Roland Schutzbach and his partner Christine about laughing~\cite{Lachen}
  ...
  It is called lauging as a habit: laughing became internalized,
  ``and when somthing goes wrong, we start by laughing about it and then as a second action, we prefer to stop it''.
