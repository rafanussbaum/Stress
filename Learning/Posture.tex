...
Our movements influence our whole life.\index{effect!well--being, improve}\index{symptom!posture, bad}\index{effect!posture}
...
Which posture is needed to avoid the strain on the structures of the body, which act as disturbances?\index{symptom!strain}
...
That will automatically make you hold your upper body in an upright position.
        ...
        and in which the {spine} can fulfill its carrying function and act as the {central axis}.\index{effect!central axis} 
...
The {pressure} which we seemingly are exposed to, puts pressure on our \emph{psyche} and mood.\index{symptom!psyche, pressure}\index{symptom!mood, pressure}

The strain of the bad posture leads to a {mechanical strain} of the {musculoskeletal system}.\index{symptom!muscles, strain}\index{symptom!bones, strain}
This strain significantly {reduces the mechanical load capacity}.
On the other side, this leads our body to react with {protective measures} to counteract that strain.\index{symptom!protective measures}
...
A {physical evasion} is possible, but severely {impairs the function} of the organs.\index{effect!organs}
...
Without peace, our progress will be stunted.\index{effect!peace}
