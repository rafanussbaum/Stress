...
Metacognitive means in our context: {transforming} or changing the {intellect},\index{effect!intellect, change} the
psyche\index{effect!psyche, change} or {thinking capacity}\index{effect!thinking capapcity, change}  and promoting the development of
functions which contribute to perception or knowledge\index{change!perception, promote}\index{effect!knowledge, promote}.
...
These exercises improve the capacity to {focus}\index{focus!training}\index{symptom!focus capacity}.
You will probably start to notice after some practice, how your awake state has been improved for the whole day\index{effect!awake state, improved}.
Furthermore, they improve the endurance in the domain of thinking\index{effect!thinking, improve endurance},
but as well the {thinking speed will increase}.\index{effect!thinking, speed increase}
After mid to long term practice, there may be improvement in {stress dominant traits} (ie. test anxiety\index{symptom!test anxiety},
low self--esteem\index{symptom!self--esteem, low} and impaired problem--thinking)\index{symptom!problem--thinking, low}.

\section{A Possibility for Regulation of Stress}


One of the problems of people who are suffering from stress is that an unhindered self--sustained dynamic created a \emph{viscous circle}.\index{vicious circle}
...
normally the \emph{inner will to change}\index{change!will to} is missing.
