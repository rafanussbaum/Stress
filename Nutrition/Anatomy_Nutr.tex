...
This ancient wisdom urges us with craving of lemons, if the immune system needs a vitamine C boost or a craving for cheese if the bones needs calcium.
...
A chemist would say: carbohydrates\index{carbohydrates}, fibers, vitamines, minerals, fat and proteins\index{proteins}.
...
They open the cells of the plants, so that the vitamines\index{vitamine} get released.
