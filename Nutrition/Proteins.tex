...
\item as antibodies, they serve to combat infections
  ...
  (\SI[parse-numbers=false]{\text{\ensuremath{92\sfrac{1}{2}}}}{\lbs}) in one year!\index{protein!weight loss}
  ...
  \item Proteins lead to a feeling of saturation
    ...
    allergic reactions.\index{symptom!allergy}\index{symptom!digestion troubles}
...
\begin{fminipage}{\textwidth}
  ...
  \item the recommended protein intake according to DACH (19--65 years old people): \SI{0.8}{\g/\kg\ body weight}
    %(\sfrac{1}{4} oz/ 20 lbs body weight)
