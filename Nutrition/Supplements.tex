...
\item Heightened needs of vital substances by modern human beings due to inner and outer strain, like:
  ...
  --- the B--vitamins\index{vitamine!B}, magnesium\index{mineral!magnesium}, \index{mineral!iron}iron, zinc\index{mineral!zinc} ---
  ...
  Even though they do right away deliver a lot of energy, caffeine\index{caffeine} and refined sugars\index{gugars!refined}
  ...
  \begin{table}[htb!]
    ...
    \begin{tabular}{p{2cm}p{4cm}p{5.5cm}}
      ...
      Vitamin C\index{vitamine!C} & 0.5 -- \SI{2}{\gram} & required amount increased during stress \\
      Vitamin B$_{12}$\index{vitamine!B12} & 25--\SI{50}{\micro\gram} (for people with resorption problems: \SI{1}{\milli\gram}; intramuscular application)
