...
From 1990 to the end of the millennia, the amount of disability cases from mental reasons doubled in Switzerland\footnote{Cases for invalidity IV}
In 2002 it was 37\% of all invalidity cases.
Since 1992, there was also a noticeable increase in the treatment of mental diseases, from 3.9\% to 5\% in the same time frame. The majority of these cases is treated by generalists and internists.

A study by SECO (the Swiss state secretary for economics) from 2002 showed, that 27\% of the Swiss population suffers from big stress. 12\% of the people have no means of compensating for it. It has to be assumed that this group is by definition prone for burnout.

\epigraph{A human is where his soul is and not where his body is located.}{attributed to \textit{Mahatma Gandhi}}

\begin{table}[htb!]
	\begin{tabbing}
	Disorders \= caused by psychotropic$^a$
	 substances. \hspace{3cm} \= 18.4\% \\
	\> Alcohol abuse and alcoholism \\
	\> Medication abuse and addiction \\
	Schizophrenia \> \> 1.5\% \\
	Affective disorders (Depression, Mania) \> \> 8.3\% \\
	Anxiety disorder \> \> 14.6\% \\
	\> Phobias \\
	\> Panic attacks \\
	\> Obsessive-compulsive disorder 
			\end{tabbing}
\caption[The life time prevalence of mental disorders]{The \emph{life time prevalence}$^b$ of mental disorders according to international studies.}
\hrule \vspace{1mm}
	\footnotesize{$^a$ acting in a stimulating or depressing manner on the psyche, the mind.} \\ \footnotesize{$^b$ the risk to suffer from that disease at one point during one's lifetime} \\
\end{table}

Especially in case of the anxiety disorders, there are other studies with significantly higher numbers (panic disorders 8.8\%, generalized anxiety disorders 5.1\%, social anxiety 13.3\%, specific phobia 11.3\%, PTSD 7.8\% ). A big German study of the end of the millennia give a life time risk to suffer from depression with 16.4\%.

The lifetime risk to suffer from any mental disorder is generally speaking very high, a 50\%. Extend and consequences can be very different. Some individuals are only affected for a short period of time, for weeks or months, where as others (roughly 60\%) are affected chronically over years or during their whole life time.

Another important point to consider is that in every second case of a mental disorder another one is also present. A "pure depression" or "pure panic disorder" is relatively rare. The most common patterns are early onset anxiety disorders which then turn into somatic symptom disorder(see \ref{sec:somatoform}, p.~\pageref{sec:somatoform}), depression and addictions.
